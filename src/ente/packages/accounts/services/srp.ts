...
import InMemoryStore, { MS_KEYS } from "../../shared/storage/InMemoryStore";
...
import type { UserVerificationResponse } from "../types/user";
...
export const generateSRPSetupAttributes = async (
    ...
    const srpSalt = await libsodium.generateSaltToDeriveKey();
